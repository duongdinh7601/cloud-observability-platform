...
- Phase 7: CI/CD and quality automation - in progress; initial CI validation, backend/frontend quality gates, and container build validation are implemented
...
- Split runtime and development dependencies so test and lint tooling are not installed in production images.
